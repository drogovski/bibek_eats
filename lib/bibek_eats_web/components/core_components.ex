defmodule BibekEatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BibekEatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BibekEatsWeb.Gettext, "errors", msg, opts)
    end
  end
